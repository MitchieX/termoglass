...
if(isset($_POST['email'])) {
    ...
    $email_to = "comercial@termoglass.com.br";
    ...
    $email_from = $_POST['telefone']; // required
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Telefone: ".clean_string($email_from)."\n";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.nathaliaornelas.com/');</script>";
